...
import java.util.List;
    ...
    public class TipsMedicalAsmaAdapter extends RecyclerView.Adapter<TipsMedicalAsmaAdapter.ViewHolder>  {
    ...
    //constructor
    public TipsMedicalAsmaAdapter(Context context , List<IPushNotification.TipsMensajes> rowsIRMedicines) {
