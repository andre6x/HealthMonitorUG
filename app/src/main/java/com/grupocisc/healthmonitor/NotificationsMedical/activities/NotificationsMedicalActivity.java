...
public class NotificationsMedicalActivity extends AppCompatActivity {
    ...
    CharSequence Titles[]={"Médicas","Diabetes","Asma"};
    ...
    private void setupTabIcons() {
        tabs.getTabAt(0).setIcon(R.mipmap.icon_doctor);
        tabs.getTabAt(1).setIcon(R.mipmap.icon_blood);
        tabs.getTabAt(2).setIcon(R.mipmap.icon_inhalator);
    }
