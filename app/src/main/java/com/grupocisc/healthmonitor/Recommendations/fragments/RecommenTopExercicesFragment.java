...
import com.grupocisc.healthmonitor.Recommendations.adapters.TopExercicesAdapter;
...
public class RecommenTopExercicesFragment extends Fragment {

    private String TAG = "TopExercicesFragment";
    private RecyclerView recyclerView;
    private TopExercicesAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.recommen_top_exer_fragment, container, false);
        ...
        if(mTopTen != null){
            if(mTopTen.getCode() == 0){
                if(mTopTen.getRows().size() > 0){
                    ...
                    adapter = new TopExercicesAdapter(getActivity(),mTopTen.getRows(), cdn);
