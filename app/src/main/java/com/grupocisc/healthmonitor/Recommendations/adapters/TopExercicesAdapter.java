...
public class TopExercicesAdapter extends RecyclerView.Adapter<TopExercicesAdapter.ViewHolder> {
    private static final String TAG = "TopExercicesAdapter";

    public Context context;
    private List<rowsTopTen> rows;
    private String cdn;

    public TopExercicesAdapter(Context context , List<rowsTopTen> rowstopTen , String cdn ) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View v = li.inflate(R.layout.top_exer_card_adapter, viewGroup, false);
