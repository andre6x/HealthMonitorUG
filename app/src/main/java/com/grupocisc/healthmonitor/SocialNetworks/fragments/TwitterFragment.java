...
public class TwitterFragment extends Fragment  {
  ...
  //  private String SEARCH_QUERY;
    ...
    private final String SEARCH_QUERY = "HealthMonitorV2";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        contenView = inflater.inflate(R.layout.social_twitter_fragment, container, false);
       // SEARCH_QUERY = getActivity().getString(R.string.twitter_search);
    ...
    public class LoadViewTask extends AsyncTask<Void, Integer, Void>
    {
        ...
        {
            searchTimeline = new UserTimeline.Builder().screenName(SEARCH_QUERY).build();
            return null;
        }
