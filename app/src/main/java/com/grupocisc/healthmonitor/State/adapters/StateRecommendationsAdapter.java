...
public class StateRecommendationsAdapter extends RecyclerView.Adapter<StateRecommendationsAdapter.MyViewHolder> {

    private static final String TAG = "StateRecomAdapter";
    ...
    public StateRecommendationsAdapter(Context ctx, List<IPushNotification.Recommendation> rawRecomendations, StateRecommendationsAdapter.MyViewHolder.ClickListener clickListener, RecyclerView recyclerView, boolean isAnimRebound)
    {
        this.context = ctx;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        StateRecommendationsAdapter.MyViewHolder mvh = new StateRecommendationsAdapter.MyViewHolder(v, clickListener);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        private StateRecommendationsAdapter.MyViewHolder.ClickListener listener;

        public MyViewHolder(View v , StateRecommendationsAdapter.MyViewHolder.ClickListener listener) {
            super(v);
