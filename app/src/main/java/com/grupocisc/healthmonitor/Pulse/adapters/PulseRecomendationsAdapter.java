...
public class PulseRecomendationsAdapter extends RecyclerView.Adapter<PulseRecomendationsAdapter.MyViewHolder> {

    private static final String TAG = "PulseRecomAdapter";
    ...
    public PulseRecomendationsAdapter(Context ctx, List<IPushNotification.Recommendation> rawRecomendations, PulseRecomendationsAdapter.MyViewHolder.ClickListener clickListener, RecyclerView recyclerView, boolean isAnimRebound)
    {
        this.context = ctx;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        PulseRecomendationsAdapter.MyViewHolder mvh = new PulseRecomendationsAdapter.MyViewHolder(v, clickListener);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        private PulseRecomendationsAdapter.MyViewHolder.ClickListener listener;

        public MyViewHolder(View v , PulseRecomendationsAdapter.MyViewHolder.ClickListener listener) {
            super(v);
