...
public class PulseRecomendationsAdapter extends RecyclerView.Adapter<PulseRecomendationsAdapter.MyViewHolder> {
    ...
    public PulseRecomendationsFragment context;
    private List<IPushNotification.Recommendation> rows;




    public PulseRecomendationsAdapter(PulseRecomendationsFragment ctx, List<IPushNotification.Recommendation> rawRecomendations)
    {
        this.context = ctx;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        PulseRecomendationsAdapter.MyViewHolder mvh = new PulseRecomendationsAdapter.MyViewHolder(v);
