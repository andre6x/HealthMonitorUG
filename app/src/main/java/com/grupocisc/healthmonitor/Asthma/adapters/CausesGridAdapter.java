...
//e
public class CausesGridAdapter extends  SelectableAdapter<CausesGridAdapter.ViewHolder> {
    private static final String TAG = "CausesGridAdapter";

    public Context context;
    private List<IV2Causes.rows> rows;
    private String cdn;
    ...
    public CausesGridAdapter(Context context , ViewHolder.ClickListener clickListener , RecyclerView recyclerView, List<IV2Causes.rows> rowsCategory , boolean isAnimRebound) {
