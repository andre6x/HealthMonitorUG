...
public class PickFlowRecommendationsAdapter extends RecyclerView.Adapter<PickFlowRecommendationsAdapter.MyViewHolder> {
    ...
    public PickFlowRecommendationsAdapter(Context ctx, List<IPushNotification.Recommendation> rawRecomendations, PickFlowRecommendationsAdapter.MyViewHolder.ClickListener clickListener, RecyclerView recyclerView, boolean isAnimRebound)
    {
        this.context = ctx;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        PickFlowRecommendationsAdapter.MyViewHolder mvh = new PickFlowRecommendationsAdapter.MyViewHolder(v, clickListener);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        private PickFlowRecommendationsAdapter.MyViewHolder.ClickListener listener;

        public MyViewHolder(View v , PickFlowRecommendationsAdapter.MyViewHolder.ClickListener listener) {
            super(v);
