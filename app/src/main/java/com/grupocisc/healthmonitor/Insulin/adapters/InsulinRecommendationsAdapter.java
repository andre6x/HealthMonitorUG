...
public class InsulinRecommendationsAdapter extends RecyclerView.Adapter<InsulinRecommendationsAdapter.MyViewHolder> {
    ...
    public InsulinRecommendationsFragment context;
    ...
    public InsulinRecommendationsAdapter(InsulinRecommendationsFragment ctx, List<IPushNotification.Recommendation> rawRecomendations)
    {
        this.context = ctx;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        InsulinRecommendationsAdapter.MyViewHolder mvh = new InsulinRecommendationsAdapter.MyViewHolder(v);
