...
//    }
    ...
    public  void selectRecomendationsDB(){
        ...
        try {
            ...
            if(Utils.getAsmaFromPreference(getActivity())!=null) {
                ...
                call_1 = notifiMensajes.getRecommendations(new IPushNotification.ParamRequest(usuario,7));
    ...
    public  void selectFiltros(){
        ...
        try {
            ...
            call_2 = notifiMensajes.getFiltering(new IPushNotification.ParamRequest(usuario,7));
