...
import com.grupocisc.healthmonitor.Complementary.adapters.CholesterolRecomendationsAdapter;
...
public class CholesterolRecomendationsFragment extends Fragment implements CholesterolRecomendationsAdapter.MyViewHolder.ClickListener {

    private String TAG = "CholesterolRecoFragment";
    private RecyclerView recyclerView;
    private CholesterolRecomendationsAdapter adapter;
    private static List<IPushNotification.Recommendation> rowsRecomendations;

    //private OnFragmentInteractionListener mListener;

    public CholesterolRecomendationsFragment() {
...
//            if (Utils.GetCholesterolFromDatabase(HealthMonitorApplicattion.getApplication().getCholesterolDao() ).size() > 0 ){
//                //asignamos datos de la tabla a la lista de objeto
//                rowsRecomendations = Utils.GetCholesterolFromDatabase(HealthMonitorApplicattion.getApplication().getCholesterolDao() );
...
//    }
    ...
    public void callsetAdapter(){
        ...
        if (adapter != null){
            ...
            Log.e(TAG,"adapter  null");
            adapter = new CholesterolRecomendationsAdapter(getActivity(), rowsRecomendations, this, recyclerView, true);
