...
public class CholesterolRecomendationsAdapter extends RecyclerView.Adapter<CholesterolRecomendationsAdapter.MyViewHolder> {

    private static final String TAG = "CholesterolRecomAdapter";
    ...
    public CholesterolRecomendationsAdapter(Context ctx, List<IPushNotification.Recommendation> rawRecomendations, CholesterolRecomendationsAdapter.MyViewHolder.ClickListener clickListener, RecyclerView recyclerView, boolean isAnimRebound)
    {
        this.context = ctx;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CholesterolRecomendationsAdapter.MyViewHolder mvh = new CholesterolRecomendationsAdapter.MyViewHolder(v, clickListener);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        private CholesterolRecomendationsAdapter.MyViewHolder.ClickListener listener;

        public MyViewHolder(View v , CholesterolRecomendationsAdapter.MyViewHolder.ClickListener listener) {
            super(v);
