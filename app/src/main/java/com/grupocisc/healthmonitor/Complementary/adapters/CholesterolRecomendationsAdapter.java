...
public class CholesterolRecomendationsAdapter extends RecyclerView.Adapter<CholesterolRecomendationsAdapter.MyViewHolder> {
    ...
    public CholesterolRecomendationsFragment context;
    private List<IPushNotification.Recommendation> rows;



    public CholesterolRecomendationsAdapter( CholesterolRecomendationsFragment ctx, List<IPushNotification.Recommendation> rawRecomendations)
    {
        this.context = ctx;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CholesterolRecomendationsAdapter.MyViewHolder mvh = new CholesterolRecomendationsAdapter.MyViewHolder(v);
