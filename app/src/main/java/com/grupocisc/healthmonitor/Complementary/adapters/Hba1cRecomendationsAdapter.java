...
public class Hba1cRecomendationsAdapter extends RecyclerView.Adapter<Hba1cRecomendationsAdapter.MyViewHolder> {
    ...
    public Hba1cRecomendationsAdapter(Context ctx, List<IPushNotification.Recommendation> rawRecomendations, Hba1cRecomendationsAdapter.MyViewHolder.ClickListener clickListener, RecyclerView recyclerView, boolean isAnimRebound)
    {
        this.context = ctx;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Hba1cRecomendationsAdapter.MyViewHolder mvh = new Hba1cRecomendationsAdapter.MyViewHolder(v, clickListener);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        private Hba1cRecomendationsAdapter.MyViewHolder.ClickListener listener;

        public MyViewHolder(View v , Hba1cRecomendationsAdapter.MyViewHolder.ClickListener listener) {
            super(v);
